...
untar bifrost-framework-1.0.23-1
cp $PKGDIR/CHANGELOG .
...
untar coreutils-7.6-4 ./bin/mv
untar coreutils-7.6-4 ./bin/nohup
untar coreutils-7.6-4 ./bin/readlink
untar coreutils-7.6-4 ./bin/rm
untar coreutils-7.6-4 ./bin/rmdir
untar coreutils-7.6-4 ./bin/shred
untar coreutils-7.6-4 ./bin/stat
untar coreutils-7.6-4 ./bin/sync
untar coreutils-7.6-4 ./bin/touch
untar coreutils-7.6-4 ./bin/cat
untar coreutils-7.6-4 ./bin/csplit
untar coreutils-7.6-4 ./bin/cut
untar coreutils-7.6-4 ./bin/head
...
untar coreutils-7.6-4 ./bin/printf
