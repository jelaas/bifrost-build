...
+
 ...
 char *lib_dir;
--- iproute2-3.6.0-orig/tc/tc.c	Mon Oct  1 15:39:21 2012
+++ iproute2-3.6.0/tc/tc.c	Fri Mar 29 15:14:08 2013
@@ -258,12 +258,107 @@
 	return ret;
 }
 
+extern struct qdisc_util cbq_qdisc_util;
+extern struct qdisc_util choke_qdisc_util;
+extern struct qdisc_util codel_qdisc_util;
...
+extern struct qdisc_util fq_codel_qdisc_util;
...
+extern struct qdisc_util mqprio_qdisc_util;
...
+extern struct qdisc_util qfq_qdisc_util;
