...
#########
# Configure
B-configure-3 --prefix=/opt/man || exit 1
...
#########
# Compile
make LDFLAGS="-static" CFLAGS="-Os -march=i586"|| exit 1
...
(ldd opt/man/bin/man|grep -qs "not a dynamic executable") || exit 1
...
rm -rf usr
[ -d opt/man/bin ] && strip opt/man/bin/*
[ -d opt/man/sbin ] && strip opt/man/sbin/*
