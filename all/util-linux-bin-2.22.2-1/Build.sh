...
SRCVER=util-linux-2.22.2
PKG=util-linux-bin-2.22.2-1 # with build version
...
pkg_install e2fsprogs-lib-1.42.5-1 || exit 2
...
#########
# Configure
$PKGDIR/B-configure-1 --prefix=/usr --bindir=/bin --enable-arch --disable-su \
