...
#########
# Configure
POPT_CFLAGS="-I/opt/musl/include" POPT_LIBS="-lpopt" B-configure-2 --prefix=/opt/av --bindir=/opt/av/bin || exit 1
...
(ldd opt/av/bin/exif|grep -qs "not a dynamic executable") || exit 1

#########
# Clean up
cd $DST || exit 1
rm -rf opt/av/share
strip opt/av/bin/exif
