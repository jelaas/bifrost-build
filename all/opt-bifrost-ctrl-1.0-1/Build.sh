...
pkg_install libssh-0.5.2-1 || exit 2
...
mkdir -p $OPTDIR/rc.d
echo yes > $OPTDIR/etc/config.flags/bifrost-ctrl
echo $PKG > $OPTDIR/pkgversion
cp -p $PKGDIR/rc $OPTDIR/rc.d/rc.bifrost-ctrl
chmod +x $OPTDIR/rc.d/rc.bifrost-ctrl
