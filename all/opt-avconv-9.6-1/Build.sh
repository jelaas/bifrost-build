...
VER=9.6
SRCVER=libav-$VER
PKG=opt-avconv-$VER-1 # with build version
...
pkg_install musl-x264-130605-1 || exit 2
...
$PKGDIR/B-configure-3 --prefix=/$OPTPREFIX \
 --enable-gpl\
 --enable-small --disable-avplay --disable-avprobe --disable-avserver\
 --enable-libmp3lame\
 --enable-libx264 \
...
echo $PKG > $OPTDIR/pkgversion.libav
