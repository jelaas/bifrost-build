...
patch -p0 < $PKGDIR/bash41-001 || exit 1
patch -p0 < $PKGDIR/bash41-002 || exit 1
patch -p0 < $PKGDIR/bash41-003 || exit 1
patch -p0 < $PKGDIR/bash41-004 || exit 1
patch -p0 < $PKGDIR/bash41-005 || exit 1
patch -p0 < $PKGDIR/bash41-006 || exit 1
patch -p0 < $PKGDIR/bash41-007 || exit 1
patch -p0 < $PKGDIR/bash41-008 || exit 1
patch -p0 < $PKGDIR/bash41-009 || exit 1
patch -p0 < $PKGDIR/bash41-010 || exit 1
patch -p0 < $PKGDIR/bash41-011 || exit 1
patch -p0 < $PKGDIR/bash41-012 || exit 1
