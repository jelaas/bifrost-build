...
cd $BUILDDIR
libtool_fix-1
sed -i '/b64_ntop(/i \ #undef b64_ntop' compat.h
#https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=631984
sed -i '/EVENT_NOEPOLL/c\setenv("EVENT_NOEPOLL", "1", 1);' osdep-linux.c
