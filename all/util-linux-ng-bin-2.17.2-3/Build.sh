...
PKG=util-linux-ng-bin-2.17.2-3 # with build version
...
#########
# Configure
$PKGDIR/B-configure-1 --prefix=/usr --bindir=/bin --enable-arch --enable-rdev --enable-init --enable-kill \
 --enable-last --enable-mesg --enable-partx --enable-raw --enable-login-utils --enable-write || exit 1
