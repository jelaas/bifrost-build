...
pkg_install util-linux-bin-2.20.1-1  || exit 2
...
sed -i 's/-rdynamic/-static/' common.gypi
patch -p0 < $PKGDIR/fs-poll.pat || exit 1
...
#########
# Configure
FULLSTATIC=yes B-configure-2 --prefix=/opt/nodejs --no-ssl2 || exit 1
...
# Clean up
cd $DST || exit 1
rm -rf opt/nodejs/lib/node_modules/npm/node_modules/node-gyp opt/nodejs/lib/node_modules/npm/bin/node-gyp-bin
rm -rf opt/nodejs/lib/node/wafadmin
