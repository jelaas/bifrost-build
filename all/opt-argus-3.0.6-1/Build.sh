...
sed -i 's/O3/Os/' common/Makefile
sed -i 's/O3/Os/' argus/Makefile
...
mkdir -p $OPTDIR/rc.d
echo yes > $OPTDIR/etc/config.flags/argus
echo $PKG > $OPTDIR/pkgversion
cp -p $PKGDIR/rc $OPTDIR/rc.d/rc.argus
chmod +x $OPTDIR/rc.d/rc.argus
