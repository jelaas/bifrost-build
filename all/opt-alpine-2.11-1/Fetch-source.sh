...
[ -s "${DST}" ] || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://slackblog.com/slackware/slackware_source/n/alpine/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://mirror.ic.ufmt.br/slackware/slackware-14.1/source/n/alpine/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://mydata.varna.net/pub/pub/slackware-14.1/source/n/imapd/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://slackware.blizoo.mk/slackware/slackware-14.1/source/n/alpine/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://ftp.naist.jp/pub/Linux/slackware/slackware64-14.1/source/n/alpine/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://ftp.kaiser.cz/linux/php/5.4.20/src/alpine/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://pkgs.fedoraproject.org/repo/pkgs/alpine/alpine-2.11.tar.xz/522b582855fed048d3dea2c5fe1e23a4/"${SRC}" \
