...
[ -s "${DST}" ] || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://www.dest-unreach.org/socat/download/Archive/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://www.dest-unreach.org/socat/download/Archive/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://adj.pasosdejesus.org/pub/OpenBSD/distfiles/"${SRC}" \
