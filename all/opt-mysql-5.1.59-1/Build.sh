...
#########
# Configure
B-configure-1 --prefix=/opt/mysql --localstatedir=/var || exit 1
...
# Clean up
cd $DST || exit 1
rm -rf opt/mysql/docs opt/mysql/include opt/mysql/share/man opt/mysql/share/info opt/mysql/lib opt/mysql/mysql-test opt/mysql/sql-bench
strip opt/mysql/bin/*
