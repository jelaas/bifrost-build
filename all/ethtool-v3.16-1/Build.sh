...
cd $BUILDDIR || exit 1
libtool_fix-1
sed -i 's/__uint8_t/uint8_t/' internal.h
sed -i 's/__uint16_t/uint16_t/' internal.h
sed -i 's/__uint32_t/uint32_t/' internal.h
sed -i 's/__int32_t/int32_t/' internal.h
