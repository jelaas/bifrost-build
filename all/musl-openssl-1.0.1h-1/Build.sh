...
pkg_install musl-1.1.2-1 || exit 2
export CC=musl-gcc
...
#########
# Configure
./Configure linux-elf --prefix=/opt/musl --openssldir=/etc/ssl no-shared no-bf no-cast no-md2 no-mdc2 no-rc2 no-rc5 no-idea no-ripemd no-dso no-jpake no-md4 no-srp
