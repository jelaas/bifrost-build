...
PKG=opt-quagga-0.99.17-1 # with build version
...
#########
# Configure
B-configure-1 --prefix=/opt/quagga --disable-shared --enable-irdp --enable-static=no --enable-rtadv --enable-user=root --enable-group=root --enable-multipath=6 --localstatedir=/var/run --disable-capabilities --disable-doc --disable-pie --enable-ipv6 || exit 1
