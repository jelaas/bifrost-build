...
B-configure-1 --prefix=/$OPTPREFIX --localstatedir=/var --enable-iproute2 --disable-plugins|| exit 1
...
cp -a sample-scripts sample-config-files $OPTDIR/etc
