...
pkg_install musl-1.1.15-1 || exit 1
...
#########
# Configure
CC=musl-gcc B-configure-1 --prefix=/opt/musl --disable-cpp --enable-utf8 --enable-unicode-properties|| exit 1
...
rm -f opt/musl/bin/pcretest opt/musl/bin/pcregrep
[ -d bin ] && strip bin/*
