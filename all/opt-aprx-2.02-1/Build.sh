...
SRC=/var/spool/src/$SRCVER.svn437.tar.gz
[ -f /var/spool/src/$SRCVER.tar.bz2 ] && SRC=/var/spool/src/$SRCVER.tar.bz2
BUILDDIR=/var/tmp/src/${SRCVER}test.svn437
...
#########
# Compile
make exec_prefix=/$OPTPREFIX prefix=/$OPTPREFIX || exit 1

#########
# Install into dir under /var/tmp/install
rm -rf "$DST"
make install exec_prefix=/$OPTPREFIX prefix=/$OPTPREFIX DESTDIR=$DST # --with-install-prefix may be an alternative
...
mv $OPTDIR/etc/aprx.conf $OPTDIR/etc/aprx.conf.sample
