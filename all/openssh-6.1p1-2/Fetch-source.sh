...
[ -s "${DST}" ] || ../../wget-finder --checksum "${MD5}" -O "${DST}" ftp://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://slackware.blizoo.mk/slackware/slackware64-14.0/source/n/openssh/"${SRC}" \
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://cpan.nust.na/OpenBSD/OpenSSH/portable/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" https://slackbuilds.org/mirror/slackware/slackware-14.0/source/n/openssh/"${SRC}" \
                ...
                || ../../wget-finder --checksum "${MD5}" -O "${DST}" http://mirrors.unix-gaming.net/openssh/"${SRC}" \
